...
while (exit_status == false)
    ...
    switch n
        ...
        case 1
            ...
            % Natural
            main_natural(b2005_s1, b2005_s2, b2005_s3);
            main_natural(b2005_w1, b2005_w2, b2005_w3);
            main_natural(b2010_s1, b2010_s2, b2010_s3);
        ...
        case 2
            ...
            % InfraRed
            main_IR(b2005_s2, b2005_s3, b2005_s4);
            main_IR(b2005_w2, b2005_w3, b2005_w4);
            main_IR(b2010_s2, b2010_s3, b2010_s4);
            main_IR(b2010_w2, b2010_w3, b2010_w4);
            main_IR(b2015_s3, b2015_s4, b2015_s5);
            main_IR(b2015_w3, b2015_w4, b2015_w5);
            main_IR(b2020_s3, b2020_s4, b2020_s5);
            main_IR(b2020_w3, b2020_w4, b2020_w5);
        case 3
            disp('Displaying NDVI')
            % NDVI
            main_NDVI(b2005_s4, b2005_s5);
            main_NDVI(b2005_w4, b2005_w5);
            main_NDVI(b2010_s4, b2010_s5);
            main_NDVI(b2010_w4, b2010_w5);
            main_NDVI(b2015_s4, b2015_s5);
            main_NDVI(b2015_w4, b2015_w5);
            main_NDVI(b2020_s4, b2020_s5);
            main_NDVI(b2020_w4, b2020_w5);
        case 4
            disp('Displaying Rrs')
            % Rrs
            main_Rrs(b2005_s1);
        ...
        case 5
            ...
            % Turbidity
            main_turbidity(b2005_s4, b2005_s5, b2005_sQA, file_2005_sQA, UL_2005_sQA, LR_2005_sQA);
            main_turbidity(b2005_w4, b2005_w5, b2005_wQA, file_2005_wQA, UL_2005_wQA, LR_2005_wQA);
            main_turbidity(b2010_s4, b2010_s5, b2010_sQA, file_2010_sQA, UL_2010_sQA, LR_2010_sQA);
            main_turbidity(b2010_w4, b2010_w5, b2010_wQA, file_2010_wQA, UL_2010_wQA, LR_2010_wQA);
            main_turbidity(b2015_s4, b2015_s5, b2015_sQA, file_2015_sQA, UL_2015_sQA, LR_2015_sQA);
            main_turbidity(b2015_w4, b2015_w5, b2015_wQA, file_2015_wQA, UL_2015_wQA, LR_2015_wQA);
            main_turbidity(b2020_s4, b2020_s5, b2020_sQA, file_2020_sQA, UL_2020_sQA, LR_2020_sQA);
            main_turbidity(b2020_w4, b2020_w5, b2020_wQA, file_2020_wQA, UL_2020_wQA, LR_2020_wQA);
        case 6
            disp('Displaying Geotemperature map')
            % Geo Map
            main_geo_temp_map(b2015_s10, b2015_sQA, file_2015_sQA, UL_2015_sQA, LR_2015_sQA);
            main_geo_temp_map(b2015_w10, b2015_wQA, file_2015_wQA, UL_2015_wQA, LR_2015_wQA);
            main_geo_temp_map(b2020_s10, b2020_sQA, file_2020_sQA, UL_2020_sQA, LR_2020_sQA);
            main_geo_temp_map(b2020_w10, b2020_wQA, file_2020_wQA, UL_2020_wQA, LR_2020_wQA);

        case 7
            disp('Displaying Clorophyll')
            % Clorophyll
            main_chlorophyll(b2005_s1, b2005_s2, b2005_s3, b2005_sQA, file_2005_sQA, UL_2005_sQA, LR_2005_sQA);
            main_chlorophyll(b2005_w1, b2005_w2, b2005_w3, b2005_wQA, file_2005_wQA, UL_2005_wQA, LR_2005_wQA);
            main_chlorophyll(b2010_s1, b2010_s2, b2010_s3, b2010_sQA, file_2010_sQA, UL_2010_sQA, LR_2010_sQA);
            main_chlorophyll(b2010_w1, b2010_w2, b2010_w3, b2010_wQA, file_2010_wQA, UL_2010_wQA, LR_2010_wQA);
            main_chlorophyll(b2015_s1, b2015_s2, b2015_s3, b2015_sQA, file_2015_sQA, UL_2015_sQA, LR_2015_sQA);
            main_chlorophyll(b2015_w1, b2015_w2, b2015_w3, b2015_wQA, file_2015_wQA, UL_2015_wQA, LR_2015_wQA);
            main_chlorophyll(b2020_s1, b2020_s2, b2020_s3, b2020_sQA, file_2020_sQA, UL_2020_sQA, LR_2020_sQA);
            main_chlorophyll(b2020_w1, b2020_w2, b2020_w3, b2020_wQA, file_2020_wQA, UL_2020_wQA, LR_2020_wQA);
        ...
        case 9
            ...
            % Water Mask
            main_water_mask(b2015_s10, b2015_sQA);
            main_water_mask(b2015_w10, b2015_wQA);
            main_water_mask(b2020_s10, b2020_sQA);
            main_water_mask(b2020_w10, b2020_wQA);
        case 10
            exit_status = true;
            %break;
        ...
        case '2005S'
            ...
            main_turbidity(b2005_s4, b2005_s5, b2005_sQA, file_2005_sQA, UL_2005_sQA, LR_2005_sQA) %?
            %Clorophyll
            main_clorophyll(b2005_s1, b2005_s2, b2005_s3, b2005_sQA, file_2005_sQA, UL_2005_sQA, LR_2005_sQA)
        ...
        case '2005W'
            ...
            main_turbidity(b2005_w4, b2005_w5, b2005_wQA, file_2005_wQA, UL_2005_wQA, LR_2005_wQA) %?
            %Clorophyll
            main_clorophyll(b2005_w1, b2005_w2, b2005_w3, b2005_wQA, file_2005_wQA, UL_2005_wQA, LR_2005_wQA)
        ...
        case '2010S'
            ...
            main_turbidity(b2010_s4, b2010_s5, b2010_sQA, file_2010_sQA, UL_2010_sQA, LR_2010_sQA) %?
            %Clorophyll
            main_clorophyll(b2010_s1, b2010_s2, b2010_s3, b2010_sQA, file_2010_sQA, UL_2010_sQA, LR_2010_sQA)
        ...
        case '2010W'
            ...
            main_turbidity(b2010_w4, b2010_w5, b2010_wQA, file_2010_wQA, UL_2010_wQA, LR_2010_wQA) %?
            %Clorophyll
            main_clorophyll(b2010_w1, b2010_w2, b2010_w3, b2010_wQA, file_2010_wQA, UL_2010_wQA, LR_2010_wQA)
        ...
        case '2015S'
            ...
            main_geo_temp_map(b2015_s10, b2015_sQA, file_2015_sQA, UL_2015_sQA, LR_2015_sQA)
            %Clorophyll
            main_clorophyll(b2015_s1, b2015_s2, b2015_s3, b2015_sQA, file_2015_sQA, UL_2015_sQA, LR_2015_sQA)
            %Temperature
            main_temp(b2015_s10)
            %Water Mask
            main_water_mask(b2015_s10, b2015_sQA)
        case '2015W'
            ...
            main_geo_temp_map(b2015_w10, b2015_wQA, file_2015_wQA, UL_2015_wQA, LR_2015_wQA)
            %Clorophyll
            main_clorophyll(b2015_w1, b2015_w2, b2015_w3, b2015_wQA, file_2015_wQA, UL_2015_wQA, LR_2015_wQA)
            %Temperature
            main_temp(b2015_w10)
            %Water Mask
            main_water_mask(b2005_w10, b2005_wQA)
        case '2020S'
            ...
            %InfraRed
            main_IR(b2020_s2, b2020_s3, b2020_s4)
            %NVDI
            main_NDVI(b2020_s4, b2020_s5)
            %Rrs
            main_Rrs(b2020_s1)
            ...
            main_geo_temp_map(b2020_s10, b2020_sQA, file_2020_sQA, UL_2020_sQA, LR_2020_sQA)
            %Clorophyll
            main_clorophyll(b2020_s1, b2020_s2, b2020_s3, b2020_sQA, file_2020_sQA, UL_2020_sQA, LR_2020_sQA)
            %Temperature
            main_temp(b2020_s10)
            %Water Mask
            main_water_mask(b2020_s10, b2020_sQA)
        ...
        case '2020W'
            ...
            main_natural(b2020_w2, b2020_w3, b2020_w4)
            %InfraRed
            main_IR(b2020_w2, b2020_w3, b2020_w4)
            %NVDI
            main_NDVI(b2020_w4, b2020_w5)
            %Rrs
            main_Rrs(b2020_w1)
            ...
            main_geo_temp_map(b2020_w10, b2020_wQA, file_2020_wQA, UL_2020_wQA, LR_2020_wQA)
            %Clorophyll
            main_chlorophyll(b2020_w1, b2020_w2, b2020_w3, b2020_wQA, file_2020_wQA)
            %Temperature
            main_temp(b2020_w10)
            %Water Mask
            main_water_mask(b2020_w10, b2020_wQA)
